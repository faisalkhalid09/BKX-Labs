...
<body>
    ...
    <script>
        (function () {
            ...
            try {
                // Use direct SafePay redirect generated by backend. This avoids brittle client SDK bootstrapping.
                window.location.replace(redirectUrl);
            } catch (error) {
                console.error('SafePay popup redirect error:', error);
                try {
                    window.location.href = redirectUrl;
                } catch (fallbackError) {
                    notifyParent({ type: 'safepay:cancelled' });
                    setStatus('Failed to start secure checkout. ' + (fallbackError && fallbackError.message ? fallbackError.message : ''));
                    window.location.href = cancelUrl;
                }
            }
        })();
