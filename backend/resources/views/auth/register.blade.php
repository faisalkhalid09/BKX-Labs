...
<div style="min-height:80vh;display:flex;align-items:center;justify-content:center;padding:3rem 1rem;background:#f8fafc;">
    <div class="card" style="width:100%;max-width:400px;padding:2.5rem;">
        ...
        <form action="{{ route('register') }}" method="POST" onsubmit="this.querySelector('button[type=submit]').innerHTML = 'Creating account...'; this.querySelector('button[type=submit]').style.opacity = '0.7'; this.querySelector('button[type=submit]').style.cursor = 'wait';">
            @csrf
            ...
            <div class="form-group">
                ...
                <div style="position:relative;">
                    <input class="form-input" type="password" id="password" name="password"
                           required autocomplete="new-password" placeholder="Minimum 8 characters" style="padding-right:2.5rem;width:100%;">
