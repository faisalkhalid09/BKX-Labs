                        ...
                        <div className="grid gap-6 lg:grid-cols-[1fr_280px]">
                            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8">
                                <div className="mb-5 rounded-2xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                                    ...
                                    <h2 className="mt-2 text-2xl font-black tracking-tight text-[var(--primary-dark)] sm:text-3xl">Privacy Policy</h2>
                                    <p className="mt-2 max-w-3xl text-sm leading-relaxed text-[var(--text-gray)]">This policy explains what we collect, why we collect it, how we share it, how long we keep it, and what rights users have. The layout follows the website theme with compact white cards, blue accents, and slate text.</p>
                                </div>

                                <div className="space-y-3">
                                    {privacySections.map((section, index) => (
                                        <section key={section.title} id={privacyNav[index].id} className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm scroll-mt-24">
                                            <div className="flex items-start gap-3">
                                                <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[var(--primary)] text-xs font-black text-white">{privacyNav[index].index}</span>
